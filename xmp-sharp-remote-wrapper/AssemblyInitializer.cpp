...
System::Reflection::Assembly^ currentDomain_AssemblyResolve(System::Object^ sender, System::ResolveEventArgs^ args)
{
    ...
    try
    {
        System::IO::Stream^ stream = System::Reflection::Assembly::GetExecutingAssembly()->GetManifestResourceStream("xmp-sharp-remote-managed.dll");
        array<System::Byte>^ buffer = gcnew array<System::Byte>((int)(stream->Length));
        stream->Read(buffer, 0, (int)(stream->Length));

        //finalPath = gcnew System::String("xmp-sharp-remote/") + args->Name->Substring(0, args->Name->IndexOf(",")) + ".dll";
